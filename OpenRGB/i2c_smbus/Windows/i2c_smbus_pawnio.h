...
| i2c_smbus_pawnio.h                                        |
|                                                           |
|   PawnIO SMBus driver interface for Windows               |
|                                                           |
...
private:
    ...
    s32 i2c_smbus_xfer(u8 addr, char read_write, u8 command, int size, i2c_smbus_data* data) override;
    s32 i2c_xfer(u8 addr, char read_write, int* size, u8* data) override;
