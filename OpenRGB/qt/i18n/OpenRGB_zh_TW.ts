...
<context>
    ...
    <message>
        <source>&lt;h2&gt;Some internal devices may not be detected:&lt;/h2&gt;&lt;p&gt;One or more I2C or SMBus interfaces failed to initialize.&lt;/p&gt;&lt;p&gt;&lt;b&gt;RGB DRAM modules, some motherboards&apos; onboard RGB lighting, and RGB Graphics Cards, will not be available in OpenRGB&lt;/b&gt; without I2C or SMBus.&lt;/p&gt;&lt;h4&gt;How to fix this:&lt;/h4&gt;&lt;p&gt;On Windows, this is usually caused by a failure to load the PawnIO driver.&lt;/p&gt;&lt;p&gt;You must first install &lt;a href=&apos;https://pawnio.eu/&apos;&gt;PawnIO&lt;/a&gt;, then run OpenRGB as administrator in order to access these devices.&lt;/p&gt;&lt;p&gt;See &lt;a href=&apos;https://help.openrgb.org/&apos;&gt;help.openrgb.org&lt;/a&gt; for additional troubleshooting steps if you keep seeing this message.&lt;br&gt;&lt;/p&gt;&lt;h3&gt;If you are not using internal RGB on a desktop this message is not important to you.&lt;/h3&gt;</source>
        <translation>&lt;h2&gt;部分內部裝置可能未被偵測到：&lt;/h2&gt;&lt;p&gt;一個或多個 I2C 或 SMBus 介面未能成功初始化。&lt;/p&gt;&lt;p&gt;&lt;b&gt;RGB 記憶體模組、部分主機板的內建 RGB 燈光，以及 RGB 顯示卡&lt;/b&gt; 若沒有 I2C 或 SMBus 將無法在 OpenRGB 中使用。&lt;/p&gt;&lt;h4&gt;如何解決：&lt;/h4&gt;&lt;p&gt;在 Windows 上，這通常是 PawnIO 驅動程式未能載入所致。&lt;/p&gt;&lt;p&gt;請先安裝 &lt;a href=&apos;https://pawnio.eu/&apos;&gt;PawnIO&lt;/a&gt;，再以系統管理員身分執行 OpenRGB，才能存取這些裝置。&lt;/p&gt;&lt;p&gt;若仍持續看到此訊息，請參考 &lt;a href=&apos;https://help.openrgb.org/&apos;&gt;help.openrgb.org&lt;/a&gt; 取得更多疑難排解步驟。&lt;br&gt;&lt;/p&gt;&lt;h3&gt;若您未使用桌上型電腦的內建 RGB，可忽略此訊息。&lt;/h3&gt;</translation>
    </message>
    <message>
