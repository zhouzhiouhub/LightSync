...
<context>
    ...
    <message>
        ...
        <translation>&lt;h2&gt;部分内部设备可能未被检测到：&lt;/h2&gt;&lt;p&gt;一个或多个 I2C 或 SMBus 接口未能成功初始化。&lt;/p&gt;&lt;p&gt;&lt;b&gt;RGB 内存模块、部分主板的内置 RGB 灯光以及 RGB 显卡&lt;/b&gt; 在缺少 I2C 或 SMBus 支持时无法在 OpenRGB 中使用。&lt;/p&gt;&lt;h4&gt;解决方法：&lt;/h4&gt;&lt;p&gt;在 Windows 上，这通常是 PawnIO 驱动加载失败造成的。&lt;/p&gt;&lt;p&gt;请先安装 &lt;a href=&apos;https://pawnio.eu/&apos;&gt;PawnIO&lt;/a&gt;，然后以管理员身份运行 OpenRGB，才能访问这些设备。&lt;/p&gt;&lt;p&gt;如果仍然看到此提示，请访问 &lt;a href=&apos;https://help.openrgb.org/&apos;&gt;help.openrgb.org&lt;/a&gt; 获取更多排障步骤。&lt;br&gt;&lt;/p&gt;&lt;h3&gt;如果你没有使用台式机内置的 RGB，此提示对你没有影响。&lt;/h3&gt;</translation>
    </message>
    <message>
